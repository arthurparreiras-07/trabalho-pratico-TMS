...
| **Git** | 2.0+ | \`git --version\` |
| **Make** (opcional) | 3.81+ | \`make --version\` |
...
Certifique-se de que as seguintes portas estão **livres** antes de iniciar:

| Porta | Serviço | Descrição |
|-------|---------|-----------|
| **3000** | Aplicação | API e métricas |
| **9090** | Prometheus | Interface web e API |
| **9093** | Alertmanager | Interface web |
| **3001** | Grafana | Dashboards |

**Verificar portas em uso:**
\`\`\`bash
# Linux/macOS
sudo lsof -i :3000 -i :9090 -i :9093 -i :3001

# Windows (PowerShell)
netstat -ano | findstr "3000 9090 9093 3001"
\`\`\`
...
# Reinicie a sessão após adicionar ao grupo docker
\`\`\`
...
#### Windows
\`\`\`bash
# Instale Docker Desktop com WSL2:
